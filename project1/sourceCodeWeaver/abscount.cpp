...
int main()
{
	...
	std::cout << "Program counts the number of positive, negative, and "
		     "zeroes entered in by the user." << std::endl;
	std::cout << "-----------------------------------------------------"
		     "------------------------------" << std::endl;
	...
	/* TO DO: Leave code here, utilize after learning more sophisticated 
